...
async function handleSaveActiveSheet(dirtyCells) {
    ...
    //     });
    // })
    await spreadsheetStore.flushSheet(dirtyCells);
}

</script>

<template>
    <ToolbarWrapper @save-active-sheet="spreadsheetStore.flushSheet"></ToolbarWrapper>
</template>